...
console.log('❌ Problem: Online Time: 5 hrs - 38 mins, Offline Time: 5 hrs - 30 mins');
...
const scenarios = [
  ...
  },
  {
    ...
    status: 'Offline',
    freshCheckIn: false,
    onlineTime: '5 hrs - 0 mins (paused)',
  ...
  },
  {
    ...
    status: 'Online',
    freshCheckIn: false,
    onlineTime: '5 hrs - 0 mins (resumes)',
