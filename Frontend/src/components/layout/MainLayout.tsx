    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="flex h-[calc(100vh-4rem)]">
        ...
        <aside
          ...
          } hidden lg:flex flex-col border-r bg-gradient-to-b from-card via-card/95 to-card/90 backdrop-blur-sm transition-all duration-300 shadow-lg`}
        >
        ...
        {mobileMenuOpen && (
          <div className="fixed inset-0 z-40 lg:hidden">
            ...
            <aside className="fixed left-0 top-16 bottom-0 w-64 border-r bg-gradient-to-b from-card via-card/95 to-card/90 backdrop-blur-sm shadow-2xl animate-slide-in flex flex-col">
