...
from app.crud.salary_crud import (
    create_employee_salary, get_employee_salary, update_employee_salary,
    delete_employee_salary, list_employee_salaries,
    ...
    try:
        ...
        if not user.email:
            raise HTTPException(
                ...
                detail="Employee does not have a verified email address"
            )
